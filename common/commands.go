...
var (
	...
	CMD_APP_INFO_DATA_RES_DTO      = []byte{0xA3, 0x01}
	CMD_HB_RES_DTO                 = []byte{0xA3, 0x02}
	CMD_REAL_DATA_RES_DTO          = []byte{0xA3, 0x03}
	CMD_W_INFO_RES_DTO             = []byte{0xA3, 0x04}
	CMD_COMMAND_RES_DTO            = []byte{0xA3, 0x05}
	CMD_COMMAND_STATUS_RES_DTO     = []byte{0xA3, 0x06}
	CMD_DEV_CONFIG_FETCH_RES_DTO   = []byte{0xA3, 0x07}
	CMD_DEV_CONFIG_PUT_RES_DTO     = []byte{0xA3, 0x08}
	CMD_GET_CONFIG                 = []byte{0xA3, 0x09}
	CMD_SET_CONFIG                 = []byte{0xA3, 0x10}
	CMD_REAL_RES_DTO               = []byte{0xA3, 0x11}
	CMD_GPST_RES_DTO               = []byte{0xA3, 0x12}
	CMD_AUTO_SEARCH                = []byte{0xA3, 0x13}
	CMD_NETWORK_INFO_RES           = []byte{0xA3, 0x14}
	CMD_APP_GET_HIST_POWER_RES     = []byte{0xA3, 0x15}
	CMD_APP_GET_HIST_ED_RES        = []byte{0xA3, 0x16}
	CMD_HB_RES_DTO_ALT             = []byte{0x83, 0x01}
	CMD_REGISTER_RES_DTO           = []byte{0x83, 0x02}
	CMD_STORAGE_DATA_RES           = []byte{0x83, 0x03}
	CMD_COMMAND_RES_DTO_2          = []byte{0x83, 0x05}
	CMD_COMMAND_STATUS_RES_DTO_2   = []byte{0x83, 0x06}
	CMD_DEV_CONFIG_FETCH_RES_DTO_2 = []byte{0x83, 0x07}
	CMD_DEV_CONFIG_PUT_RES_DTO_2   = []byte{0x83, 0x08}
	CMD_GET_CONFIG_RES             = []byte{0xDB, 0x08}
	CMD_SET_CONFIG_RES             = []byte{0xDB, 0x07}

	CMD_CLOUD_INFO_DATA_RES_DTO = []byte{0x23, 0x01}
	CMD_CLOUD_COMMAND_RES_DTO   = []byte{0x23, 0x05}
)
